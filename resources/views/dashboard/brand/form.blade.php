...
<fieldset>
	<div class="form-group">
		<div class="row">
			...
			<div class="col-md-10">
				{!! Form::text($locale."[name]", isset($brand) ? $brand->translate($locale)->name : null, ['class' => 'form-control' , 'placeholder' => trans('dashboard.'.$locale.'.name')]) !!}
			</div>
		</div>
	</div>
	<div class="form-group">
		<div class="row">
			...
			<div class="col-md-10">
				{!! Form::textarea($locale."[desc]", isset($brand) ? optional($brand->translate($locale))->desc : null, ['class' => 'form-control' , 'placeholder' => trans('dashboard.'.$locale.'.desc')]) !!}
			</div>
		</div>
	</div>
</fieldset>
	...
	<div class="row">
		...
		<div class="col-md-1">
			@if (isset($brand) && $brand->image)
				<img src="{{ $brand->image }}" class="img-thumbnail image-preview" style="width: 100%; height: 100px;;">
			@else
