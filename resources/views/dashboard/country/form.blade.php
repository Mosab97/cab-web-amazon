...
<fieldset>
	...
	<div class="form-group">
		<div class="row">
			<label class="font-medium-1  col-md-2">{{ trans('dashboard.general.nationality') }} </label>
			<div class="col-md-10">
...
<fieldset>
	<div class="form-group">
		<div class="row">
			<label class="font-medium-1 col-md-2">{{ trans('dashboard.country.key') }} <span class="text-danger">*</span></label>
			<div class="col-md-10">
				{!! Form::text("key", null, ['class' => 'form-control' , 'placeholder' => trans('dashboard.country.key')]) !!}
			</div>
		</div>
	</div>
	<div class="form-group">
...
@push('parent')
<a href="{{ route('dashboard.country.index') }}" class="breadcrumb-item"> {{ trans('dashboard.country.categories') }}</a>
@endpush
