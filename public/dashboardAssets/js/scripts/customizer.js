...
(function (window, document, $) {
  ...
  var body = $("body"),
    ...
    // Local Storage
    if(localStorage.getItem("caberz_themeColor")){
      var selectedColor = localStorage.getItem("caberz_themeColor"),
         ...
         $("#customizer-theme-colors .color-box").siblings().removeClass('selected');
         $("#customizer-theme-colors .color-box[data-color="+selectedColor+"]").addClass("selected");
        ...
        $(".layout-name[data-layout='" + currentLayout + "']").prop('checked', true);

        var navbarColor = localStorage.getItem("caberz_navbarColor");
      ...
      $("#customizer-navbar-colors .color-box").siblings().removeClass('selected');
      $("#customizer-navbar-colors .color-box[data-navbar-color="+navbarColor+"]").addClass("selected");
    // End Local Storage
  ...
  $(document).on("click", "#customizer-theme-colors .color-box", function () {
    ...
    var selectedColor = $(this).data("color"),
      ...
      localStorage.setItem("caberz_themeColor", selectedColor);
  ...
  $(".layout-name").on("click", function () {
    ...
    localStorage.setItem("caberz_currentLayout", currentLayout);
    body.removeClass("dark-layout semi-dark-layout").addClass(currentLayout);
    if (currentLayout === "") {
      mainMenu.removeClass("menu-dark").addClass("menu-light");
      navbar.removeClass("navbar-dark").addClass("navbar-light");
  ...
  $("#customizer-navbar-colors .color-box").on("click", function () {
    ...
    localStorage.setItem('caberz_navbarColor',navbarColor)
    // changes navbar colors
    if (navbarColor) {
      body
        .find(navbar)
