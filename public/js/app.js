...
window.connectToChat = function (chat_id) {
  window.Echo["private"]("caberz-chat.".concat(chat_id)).listen('.NewMessage', function (e) {
    var div = $('.chat_list');
    div.find('.no_message').remove();
    var scrolled_div = $('.scrolled_div'); // $('.dashboard_li').hide();
    // console.log(e);

    var dashboard_html = "\n                ".concat(function () {
      if (e.sender_data.id != window.Data.order_client_id) {
        var content_html = "<div class=\"chat\">\n                                <div class=\"chat-avatar\">\n                                <a class=\"avatar m-0\" data-toggle=\"tooltip\" href=\"#\" data-placement=\"right\" title=\"\" data-original-title=\"\">\n                                    <img src=\"".concat(e.sender_data.image, "\" alt=\"avatar\" height=\"40\" width=\"40\" />\n                                </a>\n                            </div>\n                            ");
        content_html += "\n                            <div class=\"chat-body\">\n                            ".concat(function () {
          if (e.message_type == 'image') {
            return "<a href=\"".concat(e.message, "\" data-fancybox=\"gallery\">\n                                        <img src=\"").concat(e.message, "\" class=\"img-thumbnail chat-image mb-2\" alt=\"\" style=\"width: auto;height: 120px;float: left;margin-left: 18px;\">\n                                    </a>");
          } else if (e.message_type == 'location') {
            return "<div class=\"chat-content-media\">\n                                                <a href=\"//www.google.com/maps/place/".concat(e.message, "\" target=\"_blank\">\n                                                    <img src=\"").concat(e.location_img, "\" class=\"img-thumbnail chat-image mb-2\" alt=\"\" style=\"width: auto;height: 120px;float: left;margin-left: 18px;\">\n                                                </a>\n                                            </div>");
          } else {
            return "<div class=\"chat-content\">\n                                                <p style=\"font-size: 1.1em;\">".concat(e.message, "</p>\n                                            </div>");
          }
        }(), "\n                              </div>");
      } else {
        ...
        content_html += "\n                         <div class=\"chat-body\">\n                         ".concat(function () {
          if (e.message_type == 'image') {
            return "<a href=\"".concat(e.message, "\" data-fancybox=\"gallery\">\n                                     <img src=\"").concat(e.message, "\" class=\"img-thumbnail chat-image mb-2\" alt=\"\" style=\"width: auto;height: 120px;float: right;margin-right: 18px;\">\n                                 </a>");
          } else if (e.message_type == 'location') {
            return "<div class=\"chat-content-media\">\n                                             <a href=\"//www.google.com/maps/place/".concat(e.message, "\" target=\"_blank\">\n                                                 <img src=\"").concat(e.location_img, "\" class=\"img-thumbnail chat-image mb-2\" alt=\"\" style=\"width: auto;height: 120px;float: right;margin-right: 18px;\">\n                                             </a>\n                                         </div>");
          } else {
            return "<div class=\"chat-content\">\n                                             <p style=\"color: #0d4e79; font-size: 1.1em;\">".concat(e.message, "</p>\n                                         </div>");
          }
        }(), "\n                           </div>");
      }
...
window.Echo.join("online").here(function (users) {
  ...
  var here_clients_count = 0; // console.log(users.length);

  users.forEach(function (user, i) {
    $("#online_".concat(user.id)).removeClass("avatar-status-busy");
    $("#online_".concat(user.id)).addClass("avatar-status-online"); // console.log(user.facility_list,user.user_type);
  ...
  $("#online_".concat(user.id)).removeClass("avatar-status-busy");
  $("#online_".concat(user.id)).addClass("avatar-status-online");
  ...
  $("#online_".concat(user.id)).removeClass("avatar-status-online");
  $("#online_".concat(user.id)).addClass("avatar-status-busy");
  ...
  if (window.cars.filter(function (item) {
    return item.driver_id == user.id;
  }).length > 0) {
    window.cars.filter(function (item) {
      return item.driver_id == user.id;
    })[0].car_marker.setMap(null);
  }

  window.cars = window.cars.filter(function (item) {
    return item.driver_id != user.id;
  });
});
...
window.Echo["private"]("caberz-update-location.driver").listenForWhisper('moving', function (e) {
  if (n[2] == 'dashboard' && (n[n.length - 1] == 'trip' || n[n.length - 2] == 'order')) {
    if (e.lat > 1 && e.lng > 1) {
      ...
      if (cars.filter(function (x) {
        return x.driver_id == e.driver_id;
      }).length == 0) {
        var car_object = {};
      ...
      for (var i = 0; i < cars.length; i++) {
        if (cars[i].driver_id == e.driver_id) {
          ...
          if (e.driver_id == window.Data.driver_id && (window.Data.order_status == 'shipped' || window.Data.order_status == 'start_trip')) {
            ...
            map.setZoom(16);
            cars[i].car_marker.animateTo(latlng, {
              pan: 'inbounds',
              duration: 2000
            });
          } else if (window.Data.order_id == null) {
...
if (window.Data.user_id != null) {
  window.Echo["private"]("caberz-notification.".concat(window.Data.user_id)).notification(function (notification) {
    var notification_html = ""; // console.log(notification);

    if (notification.type == "App\\Notifications\\Order\\ChangeOrderStatusNotification") {
      $("#order_statuses_".concat(notification.order_id, " #").concat(notification.order_status, " .timeline-icon")).addClass('bg-success');
      $("#order_statuses_".concat(notification.order_id, " #").concat(notification.order_status, " .timeline-icon")).removeClass('bg-danger');
      $("#order_statuses_".concat(notification.order_id, " #").concat(notification.order_status, " .timeline-icon")).html("<i class=\"feather icon-check font-medium-2\"></i>");
      $("#order_statuses_".concat(notification.order_id, " #").concat(notification.order_status, " p")).addClass('text-success');
      $("#order_statuses_".concat(notification.order_id, " #").concat(notification.order_status, " p")).removeClass('text-danger');
      $("#order_statuses_".concat(notification.order_id, " #").concat(notification.order_status, " .time")).html(notification.order_status_time);
      ...
      if (['driver_finish', 'client_cancel', 'driver_cancel', 'client_finish', 'admin_finish'].includes(notification.order_status) && window.Data.driver_id != null && window.Data.order_id != null) {
        var driver_map = window.cars.filter(function (item) {
          return item.driver_id == window.Data.driver_id;
        });
      ...
      if ((notification.order_status == 'shipped' || notification.order_status == 'start_trip') && window.Data.order_id == notification.order_id && window.Data.driver_id == null) {
        ...
        var driver_card_link = "<a href=\"".concat(notification.route_to_edit_driver, "\" class=\"btn btn-icon btn-icon rounded-circle btn-primary mr-1\">\n                    <i class=\"feather icon-edit-2\"></i>\n                </a>\n                <a href=\"").concat(notification.route_to_show_driver, "\" class=\"btn btn-icon btn-icon rounded-circle btn-success mr-1\">\n                    <i class=\"feather icon-airplay\"></i>\n                </a>");
        var driver_card_data = "<div>\n                    <a href=\"".concat(notification.route_to_show_driver, "\">\n                        <img src=\"").concat(notification.driver_avatar, "\" style=\"width: 80px; height: 80px;\" class=\"img-square\" alt=\"\">\n                    </a>\n                </div>\n                <div class=\"ml-2\">\n\n                    <p>\n                        <div class=\"row\">\n                            <div class=\"col-md-8\">\n                                <div class=\"chip chip-success mr-1\">\n                                    <div class=\"chip-body\">\n                                        <div class=\"avatar\">\n                                            <i class=\"feather icon-target text-bold font-small-3\"></i>\n                                        </div>\n                                        <span class=\"chip-text text-white text-bold font-small-3\"> ").concat(notification.driver.fullname, " </span>\n                                    </div>\n                                </div>\n                            </div>\n                            <div class=\"col-md-4\">\n                                <div class=\"chip chip-success mr-1\">\n                                    <div class=\"chip-body\">\n                                        <div class=\"avatar\">\n                                            <i class=\"feather icon-phone text-bold font-small-3\"></i>\n                                        </div>\n                                        <span class=\"chip-text text-white text-bold font-small-3\"> ").concat(notification.driver.phone, "</span>\n                                    </div>\n                                </div>\n                            </div>\n                        </div>\n                    </p>\n                    <p>\n                        <div class=\"row\">\n                            <div class=\"chip chip-success mr-1\">\n                                <div class=\"chip-body\">\n                                    <div class=\"avatar\">\n                                        <i class=\"feather icon-flag text-bold font-small-3\"></i>\n                                    </div>\n                                    <span class=\"chip-text text-white text-bold font-small-3\">").concat(notification.driver_orders_count_trans, "</span>\n                                </div>\n                            </div>\n                        </div>\n                    </p>\n                </div>");
      ...
      $('.notify_count').text(++notify_count); // $('.notify_count').show();

      if (notification.type == "App\\Notifications\\Order\\OrderNotification") {
        notification_html = "<a class=\"d-flex justify-content-between\" href=\"".concat(notification.route, "\">\n                                        <div class=\"media d-flex align-items-start\">\n                                            <div class=\"media-left\">\n                                            ").concat(function () {
        ...
        }(), "\n                                            </div>\n                                            <div class=\"media-body\">\n                                                <h6 class=\"primary media-heading\">").concat(notification.title, "</h6>\n                                                <small class=\"notification-text\"> ").concat(notification.body, "</small>\n                                            </div>\n                                            <small>\n                                                <time class=\"media-meta\">").concat(notification.created_at, "</time>\n                                            </small>\n                                        </div>\n                                    </a>");

        if (notification.notify_type == 'order') {
          var order_product = notification.order_ad;
          var order_tr = "<tr class=\"text-center\">\n                    <td>#".concat(notification.order_id, "</td>\n                    <td>").concat(notification.sender.fullname, "</td>\n                    <td><i class=\"fa fa-circle font-small-3 text-warning mr-50\"></i>").concat(notification.trans_order_status, "</td>\n                    <td>\n                        ").concat(notification.order_type_trans, "\n                    </td>\n                    <td>").concat(notification.created_at, "</td>\n                    <td class=\"text-center font-medium-1\">\n                    <a href=\"").concat(notification.route, "\" class=\"text-primary mr-2 font-medium-3\">\n                    <i class=\"feather icon-monitor\"></i>\n                    </a>\n                    </td>\n                    </tr>");
...
__webpack_require__(/*! /home/ksacab/public_html/cab-sa/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /home/ksacab/public_html/cab-sa/resources/sass/app.scss */"./resources/sass/app.scss");
