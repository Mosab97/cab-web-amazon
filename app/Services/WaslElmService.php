...
trait WaslElmService
{
    ...
    public function registerDriver($driver)
    {
        $body_data = [
            'driver' => [
                ...
                'dateOfBirthHijri' => (string)optional($driver->date_of_birth_hijri)->format("Y/m/d"),
                'dateOfBirthGregorian' => (string)optional($driver->date_of_birth)->format("Y-m-d"),
    ...
    public function finishTrip($order)
    {
        ...
        $end_location = $order->end_location_data;
        ...
        $body_data = [
            ...
            "destinationLatitude" => (float)@$end_location['lat'],
            "destinationLongitude" => (float)@$end_location['lng'],
